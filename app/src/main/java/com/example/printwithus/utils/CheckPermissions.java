...
public class CheckPermissions
{
    ...
    public static final int MY_PERMISSIONS_REQUEST_WRITE_EXTERNAL_STORAGE = 1235;
    ...
    public static boolean checkWriteExternalStoragePermission(final Context context)
    {
        ...
        if(currentAPIVersion>= Build.VERSION_CODES.M)
        {
            if (checkSelfPermission(context, Manifest.permission.WRITE_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED) {
                ...
                requestPermissions((Activity) context, new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE}, MY_PERMISSIONS_REQUEST_WRITE_EXTERNAL_STORAGE);
                // }
                return false;
            } else {
                return true;
