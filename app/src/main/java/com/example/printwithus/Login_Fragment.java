...
public class Login_Fragment extends  Fragment  implements OnClickListener {
    ...
    private void checkValidation() {
        ...
        //Authenticate user
        User currentUser = sqliteHelper.Authenticate(new User(null, null, getEmailId, getPassword));
        ...
        if (currentUser != null) {
            ...
            //User Logged in Successfully Launch You home screen activity
                      // Intent intent=new Intent(Login_Fragment.this,Home_Fragment.class);
           ...
           /* Fragment frg=new ContactusActivity();
            FragmentManager manager = getFragmentManager();
            FragmentTransaction transaction = manager.beginTransaction();
            transaction.add(R.id.frameContainer,frg);
            transaction.commit();
