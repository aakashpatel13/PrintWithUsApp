...
import com.example.printwithus.adaptar.ProductAdaptar;
...
public class MainActivity2 extends AppCompatActivity {
    ...
    private void productAdaptar() {
        ...
        productAdaptar = new ProductAdaptar(productList, MainActivity2.this, new ProductAdaptar.OrderCountListener() {
            @Override
            public void orderType(View v, int position) {
                Intent intent = new Intent(MainActivity2.this, ProductsSubActivity.class);
